...
from common.config import SingletonClass
...
class DatasetConfig:
    def __init__(
        ...
        self.openai_url = openai_url if openai_url is not None else os.getenv(OPENAI_URL,"https://api.openai.com/v1/chat/completions")
        self.deployed_model_url = deployed_model_url if deployed_model_url is not None else os.getenv(DEPLOYED_MODEL_URL)
